...
namespace Ecommerce01.Controllers
{
    ...
    public class CitiesController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
           ...
           // city.City = db.Cities.FirstOrDefault(c => c.CityId == company.CityId);
            city.Departament = db.Departaments.FirstOrDefault(c => c.DepartamentId == city.DepartamentId);
            city.Province = db.Provinces.FirstOrDefault(c => c.ProvinceId == city.ProvinceId);
        ...
        public ActionResult Create([Bind(Include = "CityId,Name,SigCap,DepartamentId,ProvinceId,Latitud,Longitud")] City city)
        {
            ...
            ViewBag.ProvinceId = new SelectList(DropDownHelper.GetProvinces(0), "ProvinceId", "Name", city.ProvinceId);
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.DepartamentId = new SelectList(DropDownHelper.GetDepartaments(), "DepartamentId", "Name", city.DepartamentId);
            ViewBag.ProvinceId = new SelectList(DropDownHelper.GetProvinces(city.DepartamentId), "ProvinceId", "Name", city.ProvinceId);
            return View(city);
        }
